...
from produktorganizer import ProduktOrganizer,PopupBildAuswaehlenProduktorganizer, CustomScrollviewItem, CustomScrollviewProduktOrganizer, PersonalOrganizer,ZeitOrganizer
#from kivy.lang import Builder
...
##        self.CustomLayout.BoxLayout.add_widget(self.CustomLayout.BoxLayout.Button4)
        ...
        self.Box.add_widget(self.CustomScrollviewProduktOrganizerInstanz)#(self.ProduktOrganizerInstanz)
